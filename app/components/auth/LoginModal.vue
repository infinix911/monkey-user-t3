<template>
  <Teleport to="body">
    <Transition name="modal" appear>
      <div v-if="isOpen" class="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 px-4"
        ...
        <div ref="modalRef" class="login-modal-wrapper relative flex w-full max-w-[460px] flex-col items-center">
          ...
          <img :src="logoSrc" :alt="siteConfig.identity.siteName"
            ...
            <form class="relative z-10 flex flex-col gap-4" @submit.prevent="onSubmit">
              <div class="flex gap-3 items-stretch">
                <div class="flex min-w-0 flex-1 flex-col gap-4">
                  ...
                  <div>
                    <div class="relative">
                      <input id="login-username" v-model="username" type="text" maxlength="12" autocomplete="username"
                    ...
                    <span v-if="errors.username" class="mt-1 block text-red-400 text-[13px] leading-tight">
                      {{ errors.username }}
                    </span>
                  </div>
                  ...
                  <div>
                    ...
                    <span v-if="errors.password" class="mt-1 block text-red-400 text-[13px] leading-tight">
                      {{ errors.password }}
                    </span>
                  </div>
                </div>
...
.login-card::before {
  ...
  background: var(--login-band-grad,
