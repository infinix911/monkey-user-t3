<template>
  <div class="relative cursor-pointer group [container-type:inline-size]" :class="fluid ? 'w-full' : 'flex-shrink-0'"
    ...
    <div class="hot-surface absolute inset-0 overflow-hidden"
      ...
      <!-- Thumbnail -->
      <div class="absolute left-1/2 -translate-x-1/2 overflow-hidden flex items-center justify-center z-20"
        ...
        <div class="absolute inset-0 flex items-center justify-center pointer-events-none" aria-hidden="true">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="w-12 h-12 text-white/70">
