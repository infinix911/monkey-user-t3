...
#     monkey-user-t3
#
# NUXT_API_URL is resolved by Nitro only at container start. It is never
# exposed to the browser: requests remain same-origin /api and /ws and are
# forwarded by Nuxt's server-side proxies.
#
